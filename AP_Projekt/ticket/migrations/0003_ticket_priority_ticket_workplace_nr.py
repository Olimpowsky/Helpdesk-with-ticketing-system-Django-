# Generated by Django 4.2.6 on 2024-01-07 04:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='ticket',
            name='priority',
            field=models.CharField(choices=[('Not Affecting', 'Problem nie wpływa na prace przy stanowisku'), ('Hindering', 'Problem utrudnia pracę przy stanowisku'), ('Preventing', 'Problem uniemożliwia pracę przy stanowisku')], default='Not Affecting', max_length=120),
        ),
        migrations.AddField(
            model_name='ticket',
            name='workplace_nr',
